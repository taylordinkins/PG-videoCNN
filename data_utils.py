...
ROOT = '/scratch/eecs-share/dinkinst/kth/'
def make_raw_dataset(dataset="train"):
    ...
    for category in CATEGORIES:
        ...
        for filename in filenames:
            filepath = os.path.join(ROOT, category, filename)
            #print(filepath)
    ...
    pickle.dump(data, open(ROOT+"data/%s.p" % dataset, "wb"))
...
def parse_sequence_file():
    print("Parsing 00sequences.txt")

    # Read 00sequences.txt file.
    with open('00sequences.txt', 'r') as content_file:
